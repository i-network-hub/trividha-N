var Userdb = require("../model/remedies");
...
exports.create = (req, res) => {
  ...
  //nEw Data
  const remedies_data = new Userdb({
    name: req.body.name,
...
exports.update = (req, res) => {
  ...
  uploadEdit(req, res, function (err) {
    ...
    Userdb.findByIdAndUpdate(id, remedies_data, {
