...
exports.create = (req, res) => {
  ...
  //nEw Data
  const raw_herb_data = new Userdb({
    name: req.body.name,
    content: req.body.content,
    especialities: req.body.especialities,
    benefits: req.body.benefits,
    botanicalName: req.body.benefits,
    familyName: req.body.familyName,
    commonName: req.body.commonName,
    partUsed: req.body.partUsed,
    habitat: req.body.habitat,
    curingDiseases: req.body.curingDiseases,
    whySpecial: req.body.whySpecial,
    image: imageFiles,
  });
...
exports.update = (req, res) => {
  ...
  uploadEdit(req, res, function (err) {
    ...
    console.log("line 123" + req.files);
    ...
    Userdb.findByIdAndUpdate(id, raw_herb_data, {
