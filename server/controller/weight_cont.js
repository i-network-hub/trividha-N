var Userdb = require("../model/weight_plans");
...
exports.update = (req, res) => {
  ...
  uploadEdit(req, res, function (err) {
    ...
    Userdb.findByIdAndUpdate(id, weight_data, {
