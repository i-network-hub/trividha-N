var Userdb = require("../model/newsletter");
...
exports.create = (req, res) => {
  ...
  //nEw Data
  const newsletter_data = new Userdb({
    email: req.body.email,
  });

  //save data into database
  newsletter_data
    .save(newsletter_data)
    .then((newsletter_data) => {
      res.send("Thanks for subscribing our Newsletter");
    })
    .catch((err) => {
      res.status(500).send({
